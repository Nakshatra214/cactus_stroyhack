...
class Scene(Base):
    ...
    camera_shot = Column(String(120), default="medium shot")
    animation_type = Column(String(120), default="zoom")
    motion_direction = Column(String(120), default="slow zoom in")
    visual_layers = Column(Text, nullable=True)
    text_overlay = Column(String(500), nullable=True)
    transition = Column(String(120), default="fade")
...
class SceneVersion(Base):
    ...
    visual_prompt = Column(Text, nullable=True)
    visual_description = Column(Text, nullable=True)
    camera_shot = Column(String(120), nullable=True)
    animation_type = Column(String(120), nullable=True)
    motion_direction = Column(String(120), nullable=True)
    visual_layers = Column(Text, nullable=True)
    text_overlay = Column(String(500), nullable=True)
    transition = Column(String(120), nullable=True)
    image_url = Column(String(1000), nullable=True)
    audio_url = Column(String(1000), nullable=True)
    video_clip = Column(String(1000), nullable=True)
    source_reference = Column(Text, nullable=True)
